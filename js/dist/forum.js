...
flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default.a.initializers.add('justoverclock/auto-post-count-badge', function () {
  Object(flarum_common_extend__WEBPACK_IMPORTED_MODULE_1__["extend"])(flarum_components_PostUser__WEBPACK_IMPORTED_MODULE_2___default.a.prototype, 'view', function (vnode) {
    var routeName = flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default.a.current.get('routeName');

    if (routeName === 'discussion' || routeName === 'discussion.near' || routeName === 'blogArticle') {
      var post = this.attrs.post;
      var userPosts = post.user().data.attributes.commentCount;
